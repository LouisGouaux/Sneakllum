...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('products/{id}/images', [\App\Http\Controllers\API\ProductController::class, 'update_image']);
    ...
    Route::get('user/orders', [\App\Http\Controllers\API\OrderController::class, 'get_user_orders']);
...
Route::get('orders', [\App\Http\Controllers\API\OrderController::class, 'get_order_by_number']);
