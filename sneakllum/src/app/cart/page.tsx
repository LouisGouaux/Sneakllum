            ...
            {filteredCart.length > 0 ? (
              filteredCart.map((item) => {
                ...
                return (
                  <div
                    key={key}
                    className="flex flex-col sm:flex-row items-center sm:items-start justify-between border-b border-gray-200 py-4 gap-4"
                >
                    <img
                    src={item.image}
                    alt={item.name}
                    ...
                    <div className="flex items-center justify-center w-full sm:w-auto sm:justify-start gap-2">
